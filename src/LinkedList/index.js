...
class SinglyLinkedList {
  ...
  /**
   * Push method - Inserts Node to the end of a list
  ...
  /**
   * Pop method - Removes a Node from the end of a list
  ...
  /**
   * Unshift method - Add a Node to the beginning of a list
  ...
  /**
   * Shift method - Removes a Node from the beginning of a list
   * Note - this method could also be called deleteHead
   * @params: none
   * @returns: Node
   */
  ...
  /**
   * Set method - Change the value of a Node based on it's position in a list
   * @params: { index, val }
   * @returns: Boolean
   */
  set(index, val) {
